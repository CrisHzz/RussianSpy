...
//Esta pantalla muestra los detalles de una persona
class DetailScreen extends StatelessWidget {
 ...
 //Creamos el agente!
  String _generateAgentCode() {
    ...
    final emailHash = person.email.isNotEmpty ? person.email.hashCode.abs() % 1000 : 0;
  ...
  void _navigateToEdit(BuildContext context) async {
    ...
    if (result == true) {
      // If the person was updated, we should go back to the list
      // since we can't update the current screen's person object
